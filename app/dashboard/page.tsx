...
//       issue: string
//       fix: string
//       reference?: string // Made optional to match UploadPage.tsx
//     }[]
//     raw_response: string[]
//   }
...
//   // Parse raw_response to extract violations
//   const parseRawResponse = (rawResponse: string[]): ViolationDetail[] => {
//     const violations: ViolationDetail[] = []
//     const issueRegex = /🚫 Clause:.*?🔍 Issue: (.*?)(?=✅ Fix:|$)/gs
//     const fixRegex = /✅ Fix: (.*?)(?=📚 Reference:|$)/gs
//     const referenceRegex = /📚 Reference: (.*?)(?=🚫 Clause:|$)/gs
//     const categoryRegex = /🚫 Clause:\s*["“]([^"”]+)["”]/s

//     rawResponse.forEach((response, responseIndex) => {
//       let match;
//       let issueIndex = 0;
...
//         const type = description.toLowerCase().includes("critical")
//           ? "critical"
//           : description.toLowerCase().includes("minor")
//           ? "minor"
//           : "warning"

//         // Extract fix
//         fixRegex.lastIndex = issueRegex.lastIndex
//         const fixMatch = fixRegex.exec(response)
//         const fix = fixMatch ? fixMatch[1].trim() : "N/A"

//         // Extract reference
//         referenceRegex.lastIndex = fixRegex.lastIndex
//         const referenceMatch = referenceRegex.exec(response)
//         const reference = referenceMatch ? referenceMatch[1].trim() : "N/A"

//         // Extract category from clause
//         categoryRegex.lastIndex = issueRegex.lastIndex - match[0].length
//         const categoryMatch = categoryRegex.exec(response)
//         const category = categoryMatch ? categoryMatch[1].trim() : "General"

//         // Extract page reference
//         const pageReference = reference.match(/Page \d+/)?.[0] || "N/A"

//         violations.push({
//           id: `${responseIndex}-${issueIndex}`,
//           type: type as "critical" | "minor" | "warning",
//           category,
//           description,
//           pageReference,
//           sebiRegulation: reference,
//           recommendation: fix,
//         })
//         issueIndex++
//       }
...
//           // Combine issues from issues array and raw_response
//           const allIssues = [
//             ...data.response.issues,
//             ...parseRawResponse(data.response.raw_response).map((v) => ({
//               clause: v.category,
//               issue: v.description,
//               fix: v.recommendation,
//               reference: v.sebiRegulation,
//             })),
//           ]
...
//           // Combine issues from issues array and raw_response
//           const parsedViolations = parseRawResponse(data.response.raw_response)
