...
//   sebiRegulation: string
//   recommendation: string
//   rawContent?: string // Add raw response content for each violation
// }
...
//   // Parse raw_response item to extract content
//   const parseRawResponse = (raw: string): string => {
//     try {
//       // Try parsing as JSON
//       const parsed = JSON.parse(raw)
//       // If it's an object, convert to formatted string
//       if (typeof parsed === "object" && parsed !== null) {
//         return "```json\n" + JSON.stringify(parsed, null, 2) + "\n```"
//       }
//       // If it's a string, return as-is (assuming it might be markdown or plain text)
//       return raw
//     } catch (e) {
//       // If parsing fails, treat as plain text or markdown
//       return raw
//     }
//   }
...
//                       >
//                         <div className="document-card__header">
//                           <div classNameName="document-card__info">
//                             <h3 className="document-card__title">{result.fileName}</h3>
//                             <div className="document-card__meta">
//                               <span className="document-card__time">Processed: {result.processedAt}</span>
//                               <span className="document-card__duration">Duration: {result.processingTime}</span>
